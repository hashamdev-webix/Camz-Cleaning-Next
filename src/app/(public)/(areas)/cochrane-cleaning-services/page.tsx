...
export default function Page() {
  const faqData = [
    ...
    { id: 3, question: "Is move-in or move-out cleaning available in Cochrane?", answer: "Move-in and move-out cleaning is handled within the Residential Cleaning service rather than as a separate service page. Include the home size, condition, access details and move date when booking." },
  ...
  return (
    <main className="min-h-screen bg-white">
      <CommonHeroSection
        ...
        imageFit="contain"
        title={<>Professional Cleaning Services in Cochrane for Homes &amp; Businesses</>}
      />
