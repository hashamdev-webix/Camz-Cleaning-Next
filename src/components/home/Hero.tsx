  ...
  return (
    ...
    >
      ...
      <div className="relative container-custom  grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="">
          {/* Small badge */}
          <span className="inline-block mb-2 px-4 py-1 text-base rounded-full bg-[#02C0E6] border border-white/30">
            Freshness You Feel
          </span>
          ...
          <p className="text-white mb-8 max-w-2xl w-full">
            <strong>Camz Cleaning</strong> provides professional cleaning
            services for homes, offices, and commercial spaces. Book trusted
            residential cleaning, move-in/move-out cleaning, and commercial
            cleaning services with a skilled team and flexible schedules to keep
            your space clean.
          </p>
