    ...
    <section className="bg-[#EFFAFC] py-16 px-6 md:px-12 lg:px-24 overflow-hidden">
      <div className="container-custom mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            Camz Cleaning delivers affordable residential and commercial
            cleaning designed for modern homes and busy workplaces. With 6+
            years of experience, we focus on quality, consistent results, and
            customer satisfaction using safe, effective cleaning methods that
            keep every space fresh, spotless, and healthy.
          </motion.p>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div>
                <h4 className="text-xl font-bold text-[#004A8C]">
                  Trusted Home Care
                </h4>
                <p className="text-gray-500 text-sm">
                  Trusted Home Care CamzCleaning delivers professional, detailed
                  residential cleaning for a fresh, hygienic, and comfortable
                  home every day.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Professional workplace cleaning experts keep offices spotless,
                  organized, and healthy for staff and clients. Efficient
