    ...
    <div className="space-y-12 text-gray-700">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl md:text-4xl font-extrabold text-[#0B4E9B] leading-tight">
          Vehicle Cleaning & Detailing Service Across Alberta
        </h2>
        ...
        <div className="space-y-4 font-medium">
          <p className="leading-relaxed">
            Camz Cleaning provides professional vehicle cleaning and car
            detailing services for drivers, families, and busy professionals
            across Alberta. From exterior washing and dashboard polishing to
            carpet cleaning, window cleaning, and tire shine, our team helps
            keep your vehicle fresh, clean, and comfortable after every trip,
            commute, or seasonal change.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-8">
        ...
        <p className="leading-relaxed">
          At Camz Cleaning, we understand that your car is more than just
          transportation; it’s part of your lifestyle. Our complete car cleaning
          interior and exterior service is designed to restore shine, comfort,
          and hygiene.
        </p>
        <p className="leading-relaxed">
          If you’ve been searching for vehicle cleaning services, we provide
          reliable, affordable, and convenient detailing that fits your
          schedule. From basic refresh to full car exterior detailing, every
      ...
      <section className="space-y-6">
        ...
        <p className="leading-relaxed mb-6">
          If you've been looking for a reliable{" "}
          <span className="font-bold">car tire cleaner nearby</span>, Camz
          Cleaning makes it simple and convenient.
        </p>
      ...
      */}
      ...
      <section className="space-y-6 pb-10">
        ...
        <p>
          Contact Camz Cleaning today to schedule your vehicle cleaning service
          and enjoy a spotless, refreshed ride.
        </p>
        <Link
          href="/booking"
