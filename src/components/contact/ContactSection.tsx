...
const ContactSection = () => {
  return (
    <section className="bg-[#EFFAFC] px-6 py-20 md:px-12 lg:px-24">
      <div className="container-custom mx-auto grid grid-cols-1 items-stretch gap-16 lg:grid-cols-2">
        {/* Left Side */}
        ...
        {/* Right Side */}
        <div className="flex flex-col justify-center rounded-[2rem] bg-[#0B4E9B] p-8 text-white shadow-2xl md:p-12">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/booking/"
              className="rounded-xl bg-[#02C0E6] px-8 py-3 font-bold text-white transition hover:bg-white hover:text-[#0B4E9B]"
            >
              Book Online
            </Link>
            ...
            <a
              href="mailto:info@camzcleaning.com"
              className="rounded-xl border-2 border-white px-8 py-3 font-bold text-white transition hover:bg-white hover:text-[#0B4E9B]"
            >
              Send an Email
            </a>
          </div>
