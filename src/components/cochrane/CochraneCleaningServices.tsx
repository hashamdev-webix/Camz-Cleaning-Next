      ...
      <div className="container-custom mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-5 text-gray-700 leading-relaxed font-medium">
            <p>
              At Camz Cleaning, we provide reliable, detail-oriented cleaning
              services in Cochrane for both residential and commercial
              properties. Our goal is simple: to deliver quality cleaning
              solutions that enhance hygiene, improve comfort, and help maintain
              your property.
            </p>
            <p>
              Our experienced cleaning team offers professional residential and
              commercial cleaning services in Cochrane, with customized plans
              designed to suit your space, schedule, and cleaning priorities.
              From homes and apartments to offices and business facilities, we
              focus on consistent results, efficiency, and customer satisfaction
              to keep every property spotless, organized, and well maintained.
            </p>
          </div>
