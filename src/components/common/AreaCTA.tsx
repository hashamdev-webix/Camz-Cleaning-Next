  ...
  return (
    <section className="relative w-full py-16 px-6 overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('/wp-admin/uploads/area-cta.webp')" }} // Ensure p3.webp is in your public folder
      >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <h2 className="text-4xl md:text-6xl font-extrabold text-white leading-tight">
          Book Camz Cleaning Today

        </h2>

        {/* Subtext */}
        <p className="text-white text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
        <span className="text-white">Schedule your cleaning with Camz Cleaning today in Cochrane and enjoy professional, reliable, and thorough services for a spotless home or office.</span>
