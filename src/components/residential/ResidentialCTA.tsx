  ...
  return (
    <section className="relative w-full py-16 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <span className="text-white"> Book your residential cleaning service today and enjoy a spotless, hygienic home maintained by our trusted and experienced cleaning professionals.</span>
