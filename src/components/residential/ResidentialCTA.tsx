...
const ResidentialCTA = () => {
  return (
    <section className="relative w-full py-16 px-6 overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-[#336498]/70 mix-blend-multiply"></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <p className="text-white text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          <span className="text-white">
            {" "}
            Book your residential cleaning service today and enjoy a spotless,
            hygienic home maintained by our trusted and experienced cleaning
            professionals.
          </span>
        </p>
