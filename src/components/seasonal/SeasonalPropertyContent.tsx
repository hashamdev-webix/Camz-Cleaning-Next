...
const SeasonalPropertyContent = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      footer:
        "Camz Cleaning helps keep your outdoor space clean, healthy, and well-maintained throughout the year with lawn care, garden cleanup, and seasonal maintenance services.",
    },
    {
      id: 3,
      ...
      footer:
        "With CamzCleaning, every surface shines, creating a healthier, more comfortable living space.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      footer:
        "Our experts ensure every window reflects the care you put into your property.",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      footer:
        "Keep your property's exterior safe, inviting, and well-maintained every season.",
    },
    {
      id: 8,
      ...
      footer:
        "Camz Cleaning's seasonal property services help reduce stress, save time, and keep your property in excellent condition throughout the year.",
    },
  ];
    ...
    <div className="space-y-12 text-gray-700">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl md:text-4xl font-extrabold text-[#0B4E9B] leading-tight">
          Professional Vacation Rentals & Seasonal Property Services Across
          Alberta
        </h2>
        <div className="rounded-[2rem] overflow-hidden shadow-md">
          <img
            src="/wp-admin/uploads/seasonal.webp"
            alt="Professional Seasonal Property Cleaning"
        ...
        <div className="space-y-4 font-medium">
          <p className="leading-relaxed">
            ...
            provides vacation rental cleaning and seasonal property care
            services across Calgary, Airdrie, Cochrane, Chestermere, and nearby
            Alberta areas. From Airbnb turnover cleaning and deep cleaning to
            snow removal and seasonal cleanup, the team helps keep properties
            clean, safe, and ready for guests or family use.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="leading-relaxed">
          Our services cover everything your property needs across every season.
          Whether it's snow removal, garden maintenance, or deep cleaning,
          CamzCleaning provides reliable, professional solutions to keep your
          home safe, clean, and beautiful all year round.
        </p>
      </section>
      ...
      <section className="space-y-8">
        ...
        <p className="leading-relaxed">
          We focus on delivering practical solutions for all aspects of home
          care, integrating both indoor and outdoor maintenance. Our offerings
          include:
        </p>
      ...
      <section className="space-y-6 pb-10">
        ...
        <p>
          Contact Camz Cleaning today to schedule your seasonal property service
          and keep your space fresh and well-maintained all year round.
        </p>
        <Link
          href="/booking"
          className="inline-block bg-[#0091C1] text-white px-8 py-4 rounded-lg font-bold hover:bg-[#0B4E9B] transition-colors shadow-lg"
        >
          Book Service
        </Link>
      </section>
