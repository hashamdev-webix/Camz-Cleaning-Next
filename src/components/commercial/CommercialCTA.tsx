  ...
  return (
    <section className="relative w-full py-16 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/wp-admin/uploads/service-cta-bg.webp')",
        }} // Ensure p3.webp is in your public folder
      >
        <div className="absolute inset-0 bg-[#316499]/70 mix-blend-multiply"></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <p className="text-white text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          <span className="text-white">
            {" "}
            Book your commercial cleaning today and let our skilled
            professionals keep your workplace spotless, hygienic, and running
            smoothly with reliable care.
          </span>
        </p>
